...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__activity_activity__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__alternatives_alternatives__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_activity_activity__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_models_alternative_model__ = __webpack_require__(288);
...
var TemplatePage = (function () {
    function TemplatePage(navCtrl, navParams, modalCtrl, viewCtrl, activityService, storage, planService, authService) {
        var _this = this;
    ...
    TemplatePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TemplatePage.prototype.launchActivityPage = function () {
        var _this = this;
        var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__activity_activity__["a" /* ActivityPage */]);
        modal.onDidDismiss(function (activity) {
            if (activity) {
                //console.log(activity)
                var currActivity = new __WEBPACK_IMPORTED_MODULE_8__app_models_alternative_model__["a" /* AlternativeModel */](activity, [], 0, []);
    ...
    TemplatePage.prototype.launchAlternativesPage = function (index) {
        var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_6__alternatives_alternatives__["a" /* AlternativesPage */], this.activities[index]);
        modal.present();
    };
